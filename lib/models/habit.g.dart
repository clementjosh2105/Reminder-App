...
class HabitAdapter extends TypeAdapter<Habit> {
  ...
  Habit read(BinaryReader reader) {
    ...
    return Habit(
      ...
      customDays: fields[6] != null ? (fields[6] as List).cast<int>() : const [],
      hourlyInterval: (fields[7] as int?) ?? 2,
      isEnabled: (fields[8] as bool?) ?? true,
      notificationId: fields[9] as int,
      createdAt: fields[10] as DateTime,
      completedDates: fields[11] != null ? (fields[11] as List).cast<String>() : const [],
      currentStreak: (fields[12] as int?) ?? 0,
      longestStreak: (fields[13] as int?) ?? 0,
      intervalSeconds: (fields[14] as int?) ?? 0,
      skippedDates: fields[15] != null ? (fields[15] as List).cast<String>() : const [],
      freezeDates: fields[16] != null ? (fields[16] as List).cast<String>() : const [],
    );
  }
